...
export const CERTIFICATIONS: Record<string, Certification> = {
  ...
  'saa-c03': {
    ...
    passingScore: 720,
    domains: [
      { id: 1, name: 'Design Secure Architectures', questionCount: 20, examProportion: 0.30, weight: 30, taskRange: '1.1-1.3', blurb: 'secure access, application boundaries, network controls, encryption, and data protection for AWS workloads' },
      { id: 2, name: 'Design Resilient Architectures', questionCount: 18, examProportion: 0.26, weight: 26, taskRange: '2.1-2.2', blurb: 'loosely coupled systems, scaling patterns, high availability, fault tolerance, and disaster recovery choices' },
      { id: 3, name: 'Design High-Performing Architectures', questionCount: 17, examProportion: 0.24, weight: 24, taskRange: '3.1-3.5', blurb: 'storage, compute, database, network, and data ingestion designs that meet performance and scale requirements' },
      { id: 4, name: 'Design Cost-Optimized Architectures', questionCount: 15, examProportion: 0.20, weight: 20, taskRange: '4.1-4.4', blurb: 'storage, compute, database, and network decisions that meet requirements while minimizing total cost' },
    ],
    status: 'active',
